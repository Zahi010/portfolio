...
function updateMovement() {
  ...
  if (gameState.isDropping) {
    ...
    // Camera is placed 15 units above and 10 units behind the player.
    ...
    // Look past the player down into the massive tunnel
    camera.lookAt(playerGroup.position.x, playerGroup.position.y - 30, playerGroup.position.z);
