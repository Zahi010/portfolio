...
function enterZeroGSpace() {
  ...
  // Move character high into space, far above the facility
  // Tunnel entrance is at Y=150, Z=-60
  playerGroup.position.set(0, 300, 50);
  ...
  const whGeo = new THREE.SphereGeometry(15, 32, 32);
  ...
  gameState.wormholeEntrance.position.set(0, 150, -60); // Exact start of warp curve
  ...
  if (prompt) {
    ...
    prompt.innerHTML = `USE <span>MOUSE</span> & <span>WASD</span> TO ENTER THE WORMHOLE`;
  }
}
...
window.enterMissionControl = function enterMissionControl() {
  ...
  // Remove wormhole entrance indicator
