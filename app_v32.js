...
function updateMovement() {
  ...
  if (gameState.isDropping) {
    if (gameState.warpCurve) {
       ...
       // Epic Third Person Falling Camera!
       ...
       // 6. Look perfectly down the tube relative to the player!
       // Simply match the player's rotation, then pitch slightly down so the character is centered
